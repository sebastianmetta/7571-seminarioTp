		...
		<div id="list-cliente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="contacto" title="${message(code: 'cliente.contacto.label', default: 'Contacto')}" />
					
						<g:sortableColumn property="mail" title="${message(code: 'cliente.mail.label', default: 'Mail')}" />
