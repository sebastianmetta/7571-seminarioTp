				...
				<thead>
					<tr>
						...
						<g:sortableColumn property="nickName"
							title="${message(code: 'contact.nickName.label', default: 'Nickname')}" />

						<th><g:message code="contact.phones.label"
								default="Number of Phones" /></th>
				...
				<tbody>
					<g:each in="${contactInstanceList}" status="i"
						...
						<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
							...
							<td>
								${fieldValue(bean: contactInstance, field: "nickName")}
							</td>

							<td>
								${contactInstance.phones.size()}
							</td>
