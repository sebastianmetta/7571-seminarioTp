            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="contact.nickName.label" default="Nick Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="contact.phones.label" default="Phones" /></td>
